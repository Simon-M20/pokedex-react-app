...
const PokemonList = () => {
    ...
    return (
        <section className='grid xl:grid-cols-5 md:grid-cols-4 grid-cols-2 justify-items-center gap-x-2 md:gap-x-4 md:gap-y-5 gap-y-2 md:w-11/12 w-full mx-auto pb-10 z-10'>
